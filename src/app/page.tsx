...
const concepts = [
  ...
  },
  {
    ...
    href: '/hero/c/',
    title: 'Во всю высоту',
    desc: 'По макету заказчика: тот же тёмный фон и состав, но сцена лаборатории занимает правую половину экрана целиком и растворяется в фоне.',
    note: 'Максимум присутствия сцены',
  },
];
