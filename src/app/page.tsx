...
const concepts = [
  ...
  },
  {
    ...
    href: '/hero/b/',
    title: 'Эксперимент',
    desc: 'Трёхмерная стеклянная колба: внутри светящаяся жидкость, из неё всплывают понятия C&B. Крупная типографика, много воздуха.',
    note: 'Премиальный тон по ТЗ 5.1',
  },
  {
    key: 'C',
    href: '/hero/c/',
    title: 'Химия цифр',
    desc: 'Светлая страница вместо тёмной, главный герой — крупная типографика. Дни отдельными плашками, факты первой конференции ниже. Сцена лаборатории уходит в фон под дуотоном.',
    note: 'Новое направление — уход от бренда первой конференции',
  },
];
    ...
    <main className="min-h-screen bg-bg-main px-5 py-16 lg:px-10">
      <div className="mx-auto max-w-[1100px]">
        ...
        <p className="mt-4 max-w-[640px] text-text-muted">
          Все три собраны на одном контенте — сравнивается именно визуальное решение.
