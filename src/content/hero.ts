...
/**
 * Блок «Как это было в прошлый раз» (ТЗ 4.6). Текст и ссылки — из дополнений
 * 27.07. ⚠️ Ролик и фотоколлаж лежат на Яндекс.Диске — доступа нет, постер и
 * галерея пока плейсхолдеры. videoUrl/photosUrl — внешние ссылки заказчика.
 */
export const recap = {
  text:
  ...
  facts: [
    ...
    { value: '1', label: 'день интенсива' },
    { value: '∞', label: 'нетворкинг на гала-ужине' },
  ],
  videoUrl: 'https://disk.360.yandex.ru/d/AHIArYkmGIl4RA',
  photosUrl: 'https://disk.360.yandex.ru/d/jkiUK15dp0KYzg',
} as const;

/**
 * Блок «Наши участники» (ТЗ 4.7). ⚠️ Официальный пакет логотипов лежит на
 * Яндекс.Диске (серые лого, авто-карусель) — доступа нет. Пока плейсхолдер:
 * компании, чьи представители выступали на первой конференции. Заменить на
 * утверждённый список и SVG-логотипы. Подпись строго «Участники конференции».
 */
export const participants = [
  'Яндекс', 'МТС', 'Альфа-Банк', 'Магнит', 'Черкизово',
  'Самокат', 'Лемана Про', 'Атом', 'Четыре лапы', 'START',
] as const;
