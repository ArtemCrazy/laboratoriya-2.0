      ...
      <div className="relative mx-auto max-w-[1440px] px-5 lg:px-10">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <div>
            ...
            {/* Правки 29.07: текст заказчика взамен прежнего описания */}
            <p className="mt-5 max-w-[460px] text-[17px] leading-relaxed text-text-muted">
              По итогам двух дней участники выйдут с набором идей, решений и практик
              рынка, которые можно адаптировать под задачи своей компании и представить
              бизнесу. Активный нетворкинг дополнит этот результат новыми
              профессиональными контактами и знакомствами.
            </p>
          </div>
